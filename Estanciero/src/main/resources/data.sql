...
SELECT 'Marche preso directamente',
       'destino',
       'carcel',
       0 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Error en los calculos del banco, cobre $4.000',
       'destino',
       'suma',
       4000 WHERE NOT EXISTS (
    SELECT 1 FROM cards WHERE descripcion = 'Error en los calculos del banco, cobre $4.000' AND tipo = 'destino'
);

INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Ha obtenido un segundo premio de belleza, cobre $200',
       'destino',
       'suma',
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT '5% de interes sobre cedulas hipotecarias, cobre $500',
       'destino',
       'suma',
       500 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Ha ganado un concurso agricola, cobre $2.000',
       'destino',
       'suma',
       2000 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Devolucion de impuestos, cobre $400',
       'destino',
       'suma',
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Por venta de acciones cobre $1.000',
       'destino',
       'suma',
       1000 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Vuelve atras hasta la zona Formosa Sur',
       'destino',
       'mover',
       1 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Gastos de farmacia, pague $1.000',
       'destino',
       'resta',
       1000 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Pague la poliza de seguro de $1.000',
       'destino',
       'resta',
       1000 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Multa caminera, pague $400',
       'suerte',
       'resta',
       400 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Pague $3.000 por gastos colegiales',
       'suerte',
       'resta',
       3000 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Multa por exeso de velocidad, pague $300',
       'suerte',
       'resta',
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Ha ganado la grande, cobre $10.000',
       'suerte',
       'suma',
       10000 WHERE NOT EXISTS (
    SELECT 1 FROM cards WHERE descripcion = 'Ha ganado la grande, cobre $10.000' AND tipo = 'suerte'
);

INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Cobre $1.000 por intereses bancarios',
       'suerte',
       'suma',
       1000 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Gano en las carreras, cobre $3.000',
       'suerte',
       'suma',
       3000 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Haga un paseo hasta la bodega, si pasa por la salida cobre $5.000',
       'suerte',
       'mover',
       16 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Siga hasta Buenos Aires, zona Norte',
       'suerte',
       'mover',
       40 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Siga hasta Salta, zona Norte.Si pasa por la salida cobre $5.000',
       'suerte',
       'mover',
       13 WHERE NOT EXISTS (
...
INSERT INTO cards (descripcion, tipo, accion, valor)
SELECT 'Siga hasta Santa Fe, zona Norte.Si pasa por la salida cobre $5.000',
       'suerte',
       'mover',
       26 WHERE NOT EXISTS (
